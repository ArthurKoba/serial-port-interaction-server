 ...
 */
    ...
    function Oe(t, e, i, s) {
        const n = [];
        if (!Zt(e, t.chartArea, t._minPadding))
            return n;
    ...
    function We(t, e) {
        ...
        s && !("" + s).match(Ee) && (console.warn('Invalid font style specified: "' + s + '"'),
        s = "");
        const n = {
    ...
    function ei(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                ...
                t.fullSize ? ti(t, n.left, a, i.outerWidth - n.right - n.left, o) : ti(t, e.left + l.placed, a, s, o),
                l.start = a,
                l.placed += s,
                a = t.bottom
            } else {
                ...
                t.fullSize ? ti(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : ti(t, o, e.top + l.placed, a, s),
                l.start = o,
                l.placed += s,
                o = t.right
            }
    ...
    function ui(t, e, i, s) {
        ...
        r.add(s);
        let l = fi(r, a, i, o || i);
        return null !== l && ((!ct(o) || o === i || (l = fi(r, a, o, l),
        null !== l)) && si(Array.from(r), [""], n, o, (()=>function(t, e, i) {
    ...
    function yi(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                l = h,
                h = xi(t, c + 1),
                l && h && (Tt(e[c], 0, mi) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                o = i[c + 1] / e[c],
    ...
    function wi(t, e, i, s, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            s = t.length; i < s; ++i)
                ...
                r = i < s - 1 && Zt(t[i + 1], e),
                o && (n = t[i],
                a && (n.cp1x = vi(n.cp1x, e.left, e.right),
                n.cp1y = vi(n.cp1y, e.top, e.bottom)),
                r && (n.cp2x = vi(n.cp2x, e.left, e.right),
    ...
    function Zi(t, e, i) {
        const s = t.canvas
          , n = new MutationObserver((t=>{
            let e = !1;
            for (const i of t)
                e = e || Gi(i.addedNodes, s),
                e = e && !Gi(i.removedNodes, s);
            e && i()
        }
        ));
    ...
    function is(t, i, s) {
        ...
        return r.observe(o),
        function(t, e) {
            Ji.size || window.addEventListener("resize", es),
            Ji.set(t, e)
        }(t, a),
        r
    }
    function ss(t, e, i) {
        ...
        "resize" === e && function(t) {
            Ji.delete(t),
            Ji.size || window.removeEventListener("resize", es)
        }(t)
    }
    function ns(t, i, s) {
        const n = t.canvas
    ...
    class ks {
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a,
            o = ps(s, n, this._cachedMeta.index)),
    ...
    function Cs(t, e) {
        ...
        if (o > 0) {
            ...
            for (Os(e, l, h, $(s) ? 0 : a - s, a),
            t = 0,
            i = o - 1; t < i; t++)
                Os(e, l, h, n[t], n[t + 1]);
            return Os(e, l, h, r, $(s) ? e.length : r + s),
            l
        }
        return Os(e, l, h),
        l
    ...
    class zs extends Ss {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Cs(this, this.ticks),
            this._labelSizes = null),
        ...
        generateTickLabels(t) {
            ...
            s = t.length; i < s; i++)
                n = t[i],
                n.label = Q(e.callback, [n.value, i, t], this)
        }
        ...
        fit() {
            ...
            if (o) {
                ...
                t.height = Rs(n) + o) : (t.height = this.maxHeight,
                t.width = Rs(n) + o),
            ...
            for (a = 0; a < e; ++a) {
                ...
                $(h) || Y(h)) {
                    if (Y(h))
                        ...
                        l = h.length; r < l; ++r)
                            m = h[r],
                            $(m) || Y(m) || (g = Ut(i, u.data, u.gc, g, m),
                            p += f)
                } else
                    g = Ut(i, u.data, u.gc, g, h),
                    p = f;
                n.push(g),
                o.push(p),
                x = Math.max(g, x),
        ...
        drawBorder() {
            ...
            const o = i.setContext(this.getContext(0)).lineWidth
              , a = this._borderValue;
            let r, l, h, c;
            this.isHorizontal() ? (r = qt(t, this.left, n) - n / 2,
            l = qt(t, this.right, o) + o / 2,
            h = c = a) : (h = qt(t, this.top, n) - n / 2,
    ...
    class hn {
        ...
        _initialize() {
            ...
            this.options.responsive ? this.resize() : Me(this, this.options.devicePixelRatio),
            this.bindEvents(),
            this.notifyPlugins("afterInit"),
            this
        }
        clear() {
            return Kt(this.canvas, this.ctx),
            this
        }
        stop() {
            return a.stop(this),
        ...
        _resize(t, e) {
            ...
            this._aspectRatio = this.aspectRatio,
            Me(this, a, !0) && (this.notifyPlugins("resize", {
                size: o
            }),
        ...
        buildOrUpdateScales() {
            ...
            J(n, (e=>{
                const n = e.options
                  ...
                  , a = js(o, n)
                  , r = K(n.type, e.dtype);
                void 0 !== n.position && tn(n.position, a) === tn(e.dposition) || (n.position = e.dposition),
                s[o] = !0;
                let l = null;
        ...
        _handleEvent(t, e) {
            ...
            let a = []
              , r = !1
              , l = null;
            return "mouseout" !== t.type && (a = this.getElementsAtEventForMode(t, n.mode, n, o),
            l = "click" === t.type ? this._lastEvent : t),
            this._lastEvent = null,
            Zt(t, this.chartArea, this._minPadding) && (Q(s.onHover, [t, a, this], this),
            "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || Q(s.onClick, [t, a, this], this)),
            r = !tt(a, i),
            (r || e) && (this._active = a,
    ...
    function _n(t, e, i, s) {
        ...
        (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[yn(c, a, r, l)] = !0,
        n = h)),
        o[yn(n, a, r, l)] = !0,
        t.borderSkipped = o
    }
    function yn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i,
        t = vn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = vn(t, e, i),
        t
    }
    function vn(t, e, i) {
    ...
    function Ln(t, e, i) {
        ...
        t.arc(o, a, r, s - h, i + h),
        l > n ? (h = n / l,
        t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + Mt, s - Mt),
        t.closePath(),
        t.clip()
    }
    function Rn(t, e, i, s) {
    ...
    function zn(t, e, i, s, n) {
        ...
        o.borderWidth && (a ? (t.lineWidth = 2 * o.borderWidth,
        t.lineJoin = "round") : (t.lineWidth = o.borderWidth,
        t.lineJoin = "bevel"),
    ...
    class qn extends Ss {
        ...
        draw(t, e) {
            const i = this.options;
            this.skip || i.radius < .1 || !Zt(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
        ...
        beforeElementsUpdate: (t,e,i)=>{
            ...
            t.data.datasets.forEach(((e,n)=>{
                ...
                let {start: c, count: d} = function(t, e) {
                    ...
                    return l && (n = Ht(ae(e, o.axis, a).lo, 0, i - 1)),
    ...
    var Mo = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                l = n[a],
                l && !1 !== l.fill && (l.fill = po(n, a, i.propagate))
        },
        beforeDraw(t, e, i) {
                ...
                !function(t, e, i) {
                    ...
                    r.usePointStyle) {
                        ...
                        const o = e + Math.max((f - x) / 2, 0)
                          ...
                          , r = Be(i.borderRadius);
                        s.beginPath(),
                        Object.values(r).some((t=>0 !== t)) ? ne(s, {
                            x: a,
                            y: o,
                            w: m,
                            h: x,
    ...
    class Ho extends Ss {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Vo(this, i.titleAlign, i),
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Vo(this, i.footerAlign, i),
        ...
        handleEvent(t, e) {
            ...
            let n = !1
              , o = [];
            "mouseout" !== t.type && (o = this._chart.getElementsAtEventForMode(t, i.mode, i, e),
            i.reverse && o.reverse());
    ...
    class qo extends zs {
        ...
        buildTicks() {
            ...
            const s = function(t, e) {
                ...
                w = p),
                m && x && n && Lt((a - o) / n, k / 1e3) ? (M = Math.round(Math.min((a - o) / k, h)),
                k = (a - o) / M,
                v = o,
                w = a) : b ? (v = m ? o : v,
                w = x ? a : w,
                M = l - 1,
                k = (w - v) / M) : (M = (w - v) / k,
                M = Tt(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M));
                ...
                v < o && P++,
                Tt(Math.round((v + P * k) * y) / y, o, Xo(o, _, t)) && P++) : v < o && P++); P < M; ++P)
                    i.push({
    ...
    class aa extends qo {
        ...
        drawBackground() {
            ...
            if (t) {
                ...
                i.save(),
                i.beginPath(),
                na(this, this.getDistanceFromCenterForValue(this._endValue), e, this.getLabels().length),
                i.closePath(),
                i.fillStyle = t,
                i.fill(),
                i.restore()
        ...
        drawGrid() {
            ...
            i.display) {
                for (t.save(),
                o = this.getLabels().length - 1; o >= 0; o--) {
    ...
    function ca(t, e) {
        ...
        null === a ? null : (n && (a = "week" !== n || !At(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)),
        +a)
    }
    function da(t, e, i, s) {
        const n = la.length;
    ...
    class ga extends zs {
        ...
        _generate() {
            ...
            d++)
                ua(h, c, f);
            return c !== i && "ticks" !== s.bounds && 1 !== d || ua(h, c, f),
    ...
    function pa(t, e, i) {
        ...
        i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = ae(t, "pos", e)),
        ({pos: s, time: o} = t[r]),
        ({pos: n, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = ae(t, "time", e)),
        ({time: s, pos: o} = t[r]),
        ({time: n, pos: a} = t[l]));
        const h = n - s;
